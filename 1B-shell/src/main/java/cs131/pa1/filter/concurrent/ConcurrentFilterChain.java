 ...
 * A pipeline
 */
public class ConcurrentFilterChain extends ArrayList<ConcurrentFilter> {
	public static final int DEFAULT_SIZE = 4;

	public ConcurrentFilterChain(Collection<? extends ConcurrentFilter> filters) {
		super(filters);
	}

	ConcurrentFilterChain(int size) {
		super(size);
	}
	 ...
	 * intended for errors
	 */
	private void finish(ConcurrentFilter filter) {
	 ...
	 */
	public ConcurrentFilterChain printOutput() {

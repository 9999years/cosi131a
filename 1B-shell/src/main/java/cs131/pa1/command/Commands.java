...
import cs131.pa1.filter.concurrent.EmptyFilter;
...
public class Commands {
	 ...
	 */
	private static final Map<String, Class<? extends ConcurrentFilter>>
	 ...
	 * return Class&lt;cs131.pa1.command.CatFilter&gt;. Note that
	 * this method, unlike forName, does not instantiate the class
	 * @param command
	 */
	public static Class<? extends ConcurrentFilter> classForName(String command) {
	 ...
	 * @return
	 */
	public static ConcurrentFilter forName(Arguments args) {
		try {
